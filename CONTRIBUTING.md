...
The stronger `npm run release:candidate:runtime` additionally requires an authenticated Pi 0.82.1 installation on a qualified macOS host. Native Linux and Windows lifecycle gates run through `.github/workflows/phase-5-qualification.yml`.
