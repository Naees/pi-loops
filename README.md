...
> **Compatibility:** the current 0.1.x development line is qualified on macOS, Linux, and Windows with Pi 0.82.1. We welcome collaborators to verify additional operating systems.
...
## Project status
The current 0.1.x development line includes attended goals, scheduling, proactive triggers, production hardening, and native macOS, Linux, and Windows qualification for Pi 0.82.1.
